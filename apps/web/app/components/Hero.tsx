...
const Hero = () => {
    return (
        <div className="text-black text-center flex flex-col items-center justify-start pt-10 min-h-screen relative">
            <SketchStar className="absolute top-20 left-[10%] w-10 h-10 text-orange-300/70 animate-float" />
            <SketchCircle className="absolute bottom-32 right-[15%] w-12 h-12 text-orange-300/70 animate-float-delayed" />
            <SketchSparkle className="absolute top-1/3 right-[10%] w-8 h-8 text-orange-400/70 animate-pulse-soft" />
            <Badge
                text={"Introducing Vexio"}
                className2="text-sm"
                icon={<Stars className="size-5 text-orange-500 " />}
            />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 mt-10">
                <button className="group inline-flex items-center gap-2 rounded-xl bg-orange-500 text-white px-6 py-3 font-semibold shadow-md hover:bg-orange-600 hover:shadow-lg hover:shadow-orange-400/40 active:scale-95 transition-all">
                ...
                <button className="group inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white/60 backdrop-blur-sm py-3 font-semibold hover:bg-slate-50/80 hover:shadow-md active:scale-95 transition-all px-14 text-orange-500">
