...
/**
 * Google / GitHub sign-in, shared by /login and /signup — better-auth treats
 * both as the same `sign-in/social` call (an unknown account is created on the
 * spot), so the two pages must offer the same providers or signing up with a
 * provider looks impossible from the signup page.
 *
